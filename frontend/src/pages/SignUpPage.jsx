...
const SignUpPage = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden"
    >
      <div className="p-8">
      ...
      <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
        <p className="text-sm text-gray-400">
          ...
          <Link to={"/login"} className="text-green-400 hover">
            Login
          </Link>
        </p>
      </div>
